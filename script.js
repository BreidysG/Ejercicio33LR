...
function displayBars(barNumber) {
    ...
    let separations = [50, 100, 150, 200, 250, 300, 350]; // Distancia horizontal entre las barras
    let height = [60, 100, 140, 180, 220, 260, 300]; // Altura de las barras
    if (window.innerWidth <= 700) {
        separations = [50, 100, 150, 200, 250, 300, 350]; // Reducir separaciones en dispositivos móviles
        height = [50, 75, 100, 125, 150, 175, 200]; // Reducir alturas en dispositivos móviles
    }
